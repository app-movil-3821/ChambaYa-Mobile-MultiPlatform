              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                      ...
                      child: Stack(
                        children: [
                          Container(
                            ...
                            decoration: BoxDecoration(color: const Color(0xFFE8EDFB), shape: BoxShape.circle,
                    ...
                    const SizedBox(height: 16),
                    _SettingsField(label: 'Distrito',           controller: _district,   icon: Icons.location_on_outlined),
                    const SizedBox(height: 16),
                    _SettingsField(label: 'Experiencia',        controller: _experience, icon: Icons.work_outline),
